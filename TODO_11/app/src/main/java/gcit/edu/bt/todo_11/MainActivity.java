   ...
   Button mButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_main);
         ...
         mHelloWorld = findViewById(R.id.tv1);
         mButton = findViewById (R.id.b1);
        // restore saved instance state (the text color)
        if (savedInstanceState != null) {
            mHelloWorld.setTextColor (savedInstanceState.getInt ("color"));
        }
    }
    @Override
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("color", mHelloWorld.getCurrentTextColor());
    }
    ...
    public void changeColor(View view) {
        ...
        // Set the text color.
        mHelloWorld.setTextColor(colorRes);
